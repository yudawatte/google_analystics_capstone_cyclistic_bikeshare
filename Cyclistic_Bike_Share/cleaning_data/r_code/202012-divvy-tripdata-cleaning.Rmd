---
title: "Cleaning 202012-divvy-tripdata log"
...
## Cyclistic trip data 2020 December
...
input_file <- "202012-divvy-tripdata.csv"
cleaned_tripdata_file <- "2020_12_tripdata.csv"
cleaned_station_file <- "2020_12_stations.csv"
...
valid_start_at <- ymd_hms("2020-12-01 00:00:00")
valid_end_at <- ymd_hms("2020-12-31 23:59:59")
```
...
```
##### Observations:
* There are 442 records where started_at value is greater than or equal to the ended_at value.
...
* The count of unique start station names is 645. 
* The count of unique start station ids is 643. 
...
* The count of unique start station names is 644.
* The count of unique start station ids is 642.
...
```
##### Observations:
* There are 109 entries with null values for end_latitude and end_longitude fields
