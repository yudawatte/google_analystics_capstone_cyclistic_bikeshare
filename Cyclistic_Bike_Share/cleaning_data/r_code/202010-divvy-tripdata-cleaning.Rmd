---
title: "Cleaning 202010-divvy-tripdata log"
...
## Cyclistic trip data 2020 October
...
input_file <- "202010-divvy-tripdata.csv"
cleaned_tripdata_file <- "2020_10_tripdata.csv"
cleaned_station_file <- "2020_10_stations.csv"
...
valid_start_at <- ymd_hms("2020-10-01 00:00:00")
valid_end_at <- ymd_hms("2020-10-31 23:59:59")
```
...
```
##### Observations:
* There are 1951 records where started_at value is greater than or equal to the ended_at value.
...
* The count of unique start station names is 670. 
* The count of unique start station ids is 665. 
...
```
##### Observations:
* There are 464 entries with null values for end_latitude and end_longitude fields
