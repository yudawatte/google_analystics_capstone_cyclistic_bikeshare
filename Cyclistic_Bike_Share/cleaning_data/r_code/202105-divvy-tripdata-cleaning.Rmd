---
title: "Cleaning 202105-divvy-tripdata log"
...
input_file <- "202105-divvy-tripdata.csv"
cleaned_tripdata_file <- "2021_05_tripdata.csv"
cleaned_station_file <- "2021_05_stations.csv"
...
valid_start_at <- ymd_hms("2021-05-01 00:00:00")
valid_end_at <- ymd_hms("2021-05-31 23:59:59")
```
...
```
##### Observations:
* There are 54 records where started_at value is greater than or equal to the ended_at value.
...
* The count of unique start station names is 688. 
* The count of unique start station ids is 687. 
...
* The count of unique start station names is 684.
* The count of unique start station ids is 683.
...
```
##### Observations:
* There are 452 entries with null values for end_latitude and end_longitude fields
