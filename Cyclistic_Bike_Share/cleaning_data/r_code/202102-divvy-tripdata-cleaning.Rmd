---
title: "Cleaning 202102-divvy-tripdata log"
...
## Cyclistic trip data 2021 February
...
input_file <- "202102-divvy-tripdata.csv"
cleaned_tripdata_file <- "2021_02_tripdata.csv"
cleaned_station_file <- "2021_02_stations.csv"
...
valid_start_at <- ymd_hms("2021-02-01 00:00:00")
valid_end_at <- ymd_hms("2021-02-28 23:59:59")
```
...
```
##### Observations:
* There are 4 records where started_at value is greater than or equal to the ended_at value.
...
* The count of unique start station names is 583. 
* The count of unique start station ids is 583. 
...
* The count of unique start station names is 585.
* The count of unique start station ids is 585.
...
```
##### Observations:
* There are 214 entries with null values for end_latitude and end_longitude fields
