---
title: "Cleaning 202101-divvy-tripdata log"
...
## Cyclistic trip data 2021 January
...
input_file <- "202101-divvy-tripdata.csv"
cleaned_tripdata_file <- "2021_01_tripdata.csv"
cleaned_station_file <- "2021_01_stations.csv"
...
valid_start_at <- ymd_hms("2021-01-01 00:00:00")
valid_end_at <- ymd_hms("2021-01-31 23:59:59")
```
...
```
##### Observations:
* There are 6 records where started_at value is greater than or equal to the ended_at value.
...
* The count of unique start station names is 641. 
* The count of unique start station ids is 639. 
...
* The count of unique start station names is 633.
* The count of unique start station ids is 630.
...
```
##### Observations:
* There are 102 entries with null values for end_latitude and end_longitude fields
