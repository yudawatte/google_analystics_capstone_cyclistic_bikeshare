---
title: "Cleaning 202011-divvy-tripdata log"
...
## Cyclistic trip data 2020 November
...
input_file <- "202011-divvy-tripdata.csv"
cleaned_tripdata_file <- "2020_11_tripdata.csv"
cleaned_station_file <- "2020_11_stations.csv"
...
valid_start_at <- ymd_hms("2020-11-01 00:00:00")
valid_end_at <- ymd_hms("2020-11-30 23:59:59")
```
...
```
##### Observations:
* No null values, only 2 rideable types available.
...
```
##### Observations:
* There are 893 records where started_at value is greater than or equal to the ended_at value.
* started_at greater than or equal to ended_at records need to be removed from the data set.
...
* The count of unique start station names is 666. 
* The count of unique start station ids is 662. 
...
* The count of unique start station names is 658.
* The count of unique start station ids is 657.
...
```
##### Observations:
* There are 278 entries with null values for end_latitude and end_longitude fields
