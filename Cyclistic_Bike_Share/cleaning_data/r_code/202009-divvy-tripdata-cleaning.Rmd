---
title: "Cleaning 202009-divvy-tripdata log"
...
input_file <- "202009-divvy-tripdata.csv"
cleaned_tripdata_file <- "2020_09_tripdata.csv"
cleaned_station_file <- "2020_09_stations.csv"
...
valid_start_at <- ymd_hms("2020-09-01 00:00:00")
valid_end_at <- ymd_hms("2020-09-30 23:59:59")
```
...
```
##### Observations:
* There are 2191 records where started_at value is greater than or equal to the ended_at value.
...
* The count of unique start station names is 665. 
...
* The count of unique start station names is 664.
* The count of unique start station ids is 656.
...
```
##### Observations:
* There are 777 entries with null values for end_latitude and end_longitude fields
