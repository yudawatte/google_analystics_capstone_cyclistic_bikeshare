---
title: "Cleaning 202107-divvy-tripdata log"
...
input_file <- "202107-divvy-tripdata.csv"
cleaned_tripdata_file <- "2021_07_tripdata.csv"
cleaned_station_file <- "2021_07_stations.csv"
...
valid_start_at <- ymd_hms("2021-07-01 00:00:00")
valid_end_at <- ymd_hms("2021-07-31 23:59:59")
```
...
```
##### Observations:
* There are 82 records where started_at value is greater than or equal to the ended_at value.
...
* The count of unique start station names is 718. 
* The count of unique start station ids is 711. 
...
* The count of unique start station names is 715.
* The count of unique start station ids is 708.
...
```
##### Observations:
* There are 731 entries with null values for end_latitude and end_longitude fields
