---
title: "Cleaning 202104-divvy-tripdata log"
...
## Cyclistic trip data 2021 April
...
input_file <- "202104-divvy-tripdata.csv"
cleaned_tripdata_file <- "2021_04_tripdata.csv"
cleaned_station_file <- "2021_04_stations.csv"
...
valid_start_at <- ymd_hms("2021-04-01 00:00:00")
valid_end_at <- ymd_hms("2021-04-30 23:59:59")
```
...
```
##### Observations:
* There are 38 records where started_at value is greater than or equal to the ended_at value.
...
* The count of unique start station names is 682. 
* The count of unique start station ids is 682. 
...
```
##### Observations:
* There are 267 entries with null values for end_latitude and end_longitude fields
