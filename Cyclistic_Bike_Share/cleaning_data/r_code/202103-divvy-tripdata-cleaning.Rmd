---
title: "Cleaning 202103-divvy-tripdata log"
...
## Cyclistic trip data 2021 March
...
input_file <- "202103-divvy-tripdata.csv"
cleaned_tripdata_file <- "2021_03_tripdata.csv"
cleaned_station_file <- "2021_03_stations.csv"
...
valid_start_at <- ymd_hms("2021-03-01 00:00:00")
valid_end_at <- ymd_hms("2021-03-31 23:59:59")
```
...
```
##### Observations:
* There are 12 records where started_at value is greater than or equal to the ended_at value.
...
* The count of unique start station names is 674. 
* The count of unique start station ids is 674. 
...
```
##### Observations:
* There are 167 entries with null values for end_latitude and end_longitude fields
